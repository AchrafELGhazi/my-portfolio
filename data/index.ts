...
export const gridItems = [
  ...
  {
    id: 5,
    title: "Currently working as a Software Engineer at neoCedrus",
...
export const workExperience = [
  {
    id: 1,
    title: 'Freelance Software Engineer - AUI MUN',
    desc: 'Developed a seamless website for showcasing events and enabling students to apply efficiently.',
    className: 'md:col-span-2',
    thumbnail: '/mun.png',
  },
  {
    id: 2,
    title: 'Software Engineer - neoCedrus',
    desc: 'Contributed to building and maintaining software solutions for my university, emphasizing scalability and performance.',
    className: 'md:col-span-2',
    thumbnail: '/neoCedrus.png',
  },
];
...
export const socialMedia = [
  {
    id: 1,
    img: '/git.svg',
    link: 'https://github.com/AchrafELGhazi',
  },

  {
    id: 3,
    img: '/link.svg',
    link: 'https://www.linkedin.com/in/achraf-el-ghazi-16b8bb2a7/',
  },
];
